...
export const demoNodes: DemoNode[] = [
  ...
  },
  {
    ...
    name: 'Video Intelligence Hub',
    description: 'AI-powered video analysis with transcription and intelligent summarization',
    category: 'tools',
    position: [-3, -1, -2],
    color: '#FF0000',
    icon: '🎥',
    size: 0.8,
    techStack: [
      'YouTube Data API v3', 'OpenAI Whisper', 'GPT-4 Turbo', 'FFmpeg',
      'Web Audio API', 'Natural Language Processing', 'Sentiment Analysis',
      'React', 'TypeScript', 'Next.js 15', 'Tailwind CSS'
    ],
    features: ['Advanced video transcription', 'Intelligent key points extraction', 'Interactive timeline markers', 'Multi-language support', 'Sentiment analysis', 'Chapter generation'],
    complexity: 3,
    status: 'active',
  ...
  },
  {
    ...
    description: 'Advanced data analysis platform with AI-powered insights and visualizations',
    category: 'analysis',
    position: [3, -1, -2],
    color: '#6C5CE7',
    icon: '📈',
    size: 1.1,
    techStack: [
      'OpenAI GPT-4', 'Chart.js', 'D3.js', 'Observable Plot', 'Papa Parse',
      'Excel.js', 'Apache Arrow', 'Pandas (via Pyodide)', 'Statistical Analysis',
      'React', 'TypeScript', 'Next.js 15', 'Web Workers', 'WASM'
    ],
    features: ['Interactive data visualization', 'Statistical modeling', 'Pattern recognition', 'Automated report generation', 'Predictive analytics', 'Data quality assessment'],
    complexity: 4,
    status: 'active',
  ...
  },
  {
    ...
    description: 'Advanced retrieval-augmented generation with multi-modal document understanding',
    category: 'ai',
    position: [0, -3, 0],
    color: '#00B894',
    icon: '📁',
    size: 1.0,
    techStack: [
      'LangChain', 'Supabase pgvector', 'OpenAI Embeddings', 'GPT-4',
      'Document Loaders', 'Text Splitters', 'Vector Similarity Search',
      'Retrieval QA Chains', 'React', 'TypeScript', 'Next.js 15'
    ],
    features: ['Multi-format document processing', 'Semantic vector search', 'Context-aware retrieval', 'Multi-source knowledge fusion', 'Citation tracking', 'Real-time indexing'],
    complexity: 4,
    status: 'active',
