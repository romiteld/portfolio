    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        >
          ...
          <div className="text-2xl font-bold text-white">{minTime}ms</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <h4 className="text-white font-semibold mb-4">Response Time Trend</h4>
          <div className="h-48">
        ...
        <motion.div
          ...
          className="bg-gray-800/30 rounded-xl p-4 border border-gray-700"
        >
          <h4 className="text-white font-semibold mb-4">Provider Performance</h4>
          <div className="h-48">
      ...
      <motion.div
        ...
        className="mt-6 p-4 bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-xl border border-purple-500/30"
      >
        <div className="flex items-start gap-3">
          <Zap className="w-5 h-5 text-purple-400 flex-shrink-0 mt-0.5" />
          <div>
            <h5 className="text-white font-semibold mb-1">Performance Tip</h5>
